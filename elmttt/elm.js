...
var _nickbdyer$elm_ttt$Board$new = function (width) {
	return A2(
...
var _nickbdyer$elm_ttt$Board$winner = function (board) {
	...
	var potentialWinners = A2(_elm_lang$core$Array$map, _nickbdyer$elm_ttt$Board$winnerOnLine, combos);
	return _elm_lang$core$Maybe$oneOf(
		_elm_lang$core$Array$toList(potentialWinners));
};
	...
	return _elm_lang$core$Array$toList(
		A2(
			...
			function (_p0) {
				var _p1 = _p0;
				return _elm_lang$core$Array$toList(
					A3(_elm_lang$core$Array$slice, _p1._0, _p1._1, indexedBoard));
			},
			slicePoints));
};
var _nickbdyer$elm_ttt$UI$showGameState = function (game) {
	var _p2 = _nickbdyer$elm_ttt$Game$retrieveState(game);
	switch (_p2.ctor) {
		case 'Winner':
			return A2(
...
var _nickbdyer$elm_ttt$UI$showCells = F2(
	function (line, state) {
		return A2(
			...
			function (_p3) {
				var _p4 = _p3;
				var _p5 = {ctor: '_Tuple2', _0: _p4._1, _1: state};
				if (_p5._0.ctor === 'Just') {
					return A2(
								...
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											_nickbdyer$elm_ttt$UI$Mark(_p4._0))
										]),
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text('')
...
var _nickbdyer$elm_ttt$TicTacToe$initialModel = _nickbdyer$elm_ttt$Game$new(
	_nickbdyer$elm_ttt$Board$new(3));
var _nickbdyer$elm_ttt$TicTacToe$update = F2(
	function (msg, model) {
		...
		if (_p0.ctor === 'Mark') {
			...
			return _nickbdyer$elm_ttt$TicTacToe$initialModel;
		}
	});
var _nickbdyer$elm_ttt$TicTacToe$main = {
	main: _elm_lang$html$Html_App$beginnerProgram(
		{model: _nickbdyer$elm_ttt$TicTacToe$initialModel, update: _nickbdyer$elm_ttt$TicTacToe$update, view: _nickbdyer$elm_ttt$TicTacToe$view})
};
